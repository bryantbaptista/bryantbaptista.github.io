...
<div class="text-center p-4">
  <img width="200px" src="../img/configure.png" class="img-thumbnail" >
</div>
...
As a member of the UAV Hardware - Avionics subsystem, my responsibilties involved:
 ...
 • Tested a LiDAR altitude sensor with the UAS flight controller over I2C, monitoring telemetry through Mission Planner ground control station to verify sensor functionality
